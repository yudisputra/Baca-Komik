...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2018 at 05:32 AM
...
(27, 'Satu Pukulan', 1, '2012-10-20', 18, 10),
(28, 'Mata Binatang', 1, '2017-12-07', 48, 11);
...
(10, 'One Punch Man', 'Murata Yusuke', 'Ongoing', 'One Punch Man berpusat pada seorang karakter yakni bernama Saitama, setelah berlatih keras selama 3 tahun, satama akhirnya berhasil memiliki kekuatan yang luar biasa dan membuatnya bisa mengalahkan semua monster hanya dengan satu pukulan.', '2012-10-20', 'onepunch.jpg'),
(11, 'Naka no Hito Genome [Jikkyouchuu]', 'Osora', 'Ongoing', 'Kisah Iride Akatsuki seorang youtuber gamer terkenal yang terjebak didalam dunia game bersama dengan youtuber gamer lainnya. Game nyata seperti apakah yang akan dihadapi mereka ?', '2017-12-07', 'jikyouchu.jpg'),
(12, 'Honzuki no Gekokujou', 'Kazuki Miya', 'Ongoing', 'eorang mahasiswa yang mencintai buku yang baru mendapatkan sertifikasi Pustakawan dan seharusnya memasuki pekerjaan mimpinya setelah lulus, terbunuh saat terjadi gempa besar yang menghancurkannya di bawah tumpukan koleksi buku besarnya sendiri. Berharap reinkarnasi untuk membaca lebih jauh lagi, dia bereinkarnasi ke dunia dengan tingkat melek huruf yang rendah dan sedikit sekali buku, hanya terbatas pada bangsawan dunia. Saat dia bereinkarnasi sebagai anak perempuan berusia 5 tahun dari seorang tentara rendahan, Maine, tidak peduli berapa banyak yang ingin dia baca, tidak mungkin ada buku di sekitar sini. Jika tidak ada buku maka apa yang Anda lakukan? Anda tentu saja membuat mereka sendiri ... Apa tujuannya adalah, menjadi pustakawan, tidak peduli apa, dan menjalani kehidupan yang dikelilingi oleh buku. Sebagai permulaan, dia mulai membuatnya.', '2016-04-03', 'honzuki.jpg');
...
INSERT INTO `user` (`iduser`, `namauser`, `password`, `nickname`) VALUES
(1, 'Yudistira Eka Putra', 'f6441d3ffe756334505c5d2a0bfe5f9e', 'AdminYudis'),
(2, 'refly_ilham', '202cb962ac59075b964b07152d234b70', 'FlyFly');
...
--
ALTER TABLE `chapter`
  MODIFY `idchapter` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `komik`
--
ALTER TABLE `komik`
  MODIFY `idkomik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
